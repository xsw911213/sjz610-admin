<template>
	<section style="position:relative;">
		<div class="phone">
			...
			<el-upload v-else class="avatar-uploader" action="//up.qbox.me/" :show-file-list="false" :data="uploadform" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
				<i class="el-icon-plus avatar-uploader-icon"></i>
			</el-upload>
		</div>
		<div class="btns">
			图片大小限制为 <el-input v-model="maxSize" size="small"></el-input> M
	...
	export default {
		...
		methods:{
			init (){
				...
				let reqConfig = {
					method: 'get',
					path: _this.host.baseUrl + '/viewservice'
				}
